...
class _OrderInvoiceState extends State<OrderInvoice> {
  ...
  Widget build(BuildContext context) {
    ...
    var phone = Provider.of<DetailsState>(context, listen: false)
        .phone_number
        .toString();
    var email =
        Provider.of<DetailsState>(context, listen: false).email.toString();
    var orderId =
        Provider.of<DetailsState>(context, listen: false).order_id.toString();
    var budget =
        Provider.of<DetailsState>(context, listen: false).Budget.toString();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Order By:', style: TextStyle(fontSize: 15)),
                        const SizedBox(height: 2.0),
                        Text(fullName, style: const TextStyle(fontSize: 15)),
                        const SizedBox(height: 8.0),
